...
#reco and dump laserCorrection and Time into tree
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('laser_correction_time_dump.root')
)
...
process.laserCorrectionTime_step = cms.Path(process.LaserCorrectionTimeAnalyzer)
...
process.schedule = cms.Schedule(process.raw2digi_step,
                                ...
                                process.laserCorrectionTime_step
                                )
